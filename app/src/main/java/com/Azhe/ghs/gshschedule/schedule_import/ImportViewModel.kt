...
import com.Azhe.ghs.gshschedule.schedule_import.exception.NetworkErrorException
...
import com.Azhe.ghs.gshschedule.schedule_import.parser.*
import com.Azhe.ghs.gshschedule.schedule_import.parser.qz.QzBrParser
import com.Azhe.ghs.gshschedule.schedule_import.parser.qz.QzCrazyParser
import com.Azhe.ghs.gshschedule.schedule_import.parser.qz.QzParser
import com.Azhe.ghs.gshschedule.schedule_import.parser.qz.QzWithNodeParser
import com.Azhe.ghs.gshschedule.utils.MyRetrofitUtils
            ...
            withContext(Dispatchers.Default) {
                for (i in 0 until courseList.length()) {
                    baseList.add(CourseBaseBean(i,
                            ...
                            color = "#${Integer.toHexString(ViewUtils.getCustomizedColor(getApplication(), i % 16))}",
                            tableId = importId
                    ))
...
//                .post()
        ...
        for (i in 0 until course.size - 1) {
            ...
            baseList.add(CourseBaseBean(
                    ...
                    color = "#${Integer.toHexString(ViewUtils.getCustomizedColor(getApplication(), baseList.size % 16))}",
                    tableId = importId
            ))
