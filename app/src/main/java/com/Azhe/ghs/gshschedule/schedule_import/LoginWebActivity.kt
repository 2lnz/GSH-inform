...
class LoginWebActivity : BaseActivity() {
    ...
    private val fabLogin: FloatingActionButton?
        get() = (supportFragmentManager.findFragmentById(android.R.id.content) as? LoginWebFragment)?.fabLogin
    ...
    override fun onBackPressed() {
        ...
        if (suda != null && fabLogin?.isExpanded == true) {
            fabLogin?.isExpanded = false
        } else {
            super.onBackPressed()
        }
    }
